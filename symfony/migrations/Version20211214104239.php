 ...
 */
final class Version20211214104239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bills (id INT AUTO_INCREMENT NOT NULL, trainings_id INT DEFAULT NULL, company_id INT NOT NULL, comedian_id INT NOT NULL, num_stage INT NOT NULL, bdc VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, paid TINYINT(1) NOT NULL, inter_date DATE NOT NULL, INDEX IDX_22775DD0161BA2FF (trainings_id), INDEX IDX_22775DD0979B1AD6 (company_id), INDEX IDX_22775DD01D3228F (comedian_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE companies (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(60) NOT NULL, phone_number VARCHAR(12) NOT NULL, siret VARCHAR(14) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE bills ADD CONSTRAINT FK_22775DD0161BA2FF FOREIGN KEY (trainings_id) REFERENCES trainings (id)');
